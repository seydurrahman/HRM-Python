...
class Section(models.Model):
    department = models.ForeignKey(
        'accounts.Department',  # string reference avoids circular import
        on_delete=models.CASCADE,
    ...
    manager = models.ForeignKey(
        'employees.Employee',  # lazy string reference
        on_delete=models.SET_NULL,
        null=True,
        blank=True,
...
# #     class Meta:
# #         db_table = 'departments_dept'
# #         ordering = ['name']
    
# #     def __str__(self):
# #         return f"{self.code} - {self.name}"
# # class SectionSec(models.Model):

...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            name='category',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='grievances', to='grievance.grievancecategory'),
        ),
        migrations.AddField(
            model_name='grievance',
            name='employee',
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='disciplinary_actions', to='grievance.grievance'),
        ),
        migrations.AddIndex(
            model_name='grievance',
